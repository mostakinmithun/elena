...
},{"imagesloaded":"lc7f"}],"BeZ8":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl","./utils":"MgTz"}],"NJSX":[function(require,module,exports) {
...
},{}],"cwez":[function(require,module,exports) {
module.exports = "21.153c3a00.jpg";
},{}],"Kdac":[function(require,module,exports) {
module.exports = "22.787cf170.jpg";
},{}],"enHr":[function(require,module,exports) {
module.exports = "23.486b8c96.jpg";
},{}],"X5n9":[function(require,module,exports) {
module.exports = "24.fff42ead.jpg";
},{}],"LXWM":[function(require,module,exports) {
module.exports = "25.4550eb4f.jpg";
},{}],"Yk3M":[function(require,module,exports) {
module.exports = "26.2e93c17c.jpg";
},{}],"XCdc":[function(require,module,exports) {
module.exports = "27.4a259712.jpg";
},{}],"x75a":[function(require,module,exports) {
module.exports = "28.1b075856.jpg";
},{}],"EOzq":[function(require,module,exports) {
module.exports = "29.474079f1.jpg";
},{}],"P8tY":[function(require,module,exports) {
module.exports = "3.a433b89d.jpg";
},{}],"qjp4":[function(require,module,exports) {
module.exports = "30.e673968d.jpg";
},{}],"c3lz":[function(require,module,exports) {
module.exports = "31.dfbd55a8.jpg";
},{}],"kgsa":[function(require,module,exports) {
module.exports = "32.d054f62f.jpg";
},{}],"CWo3":[function(require,module,exports) {
module.exports = "33.7058d352.jpg";
},{}],"HaGS":[function(require,module,exports) {
module.exports = "34.f8e0a6a3.jpg";
},{}],"ZCjW":[function(require,module,exports) {
module.exports = "35.e3312292.jpg";
},{}],"Heda":[function(require,module,exports) {
module.exports = "36.0448c5b0.jpg";
},{}],"jmQK":[function(require,module,exports) {
module.exports = "37.49a0780f.jpg";
},{}],"Oxcm":[function(require,module,exports) {
module.exports = "38.d80dd7b6.jpg";
},{}],"aZIu":[function(require,module,exports) {
module.exports = "39.f6a22a1b.jpg";
},{}],"kPmT":[function(require,module,exports) {
module.exports = "4.c6d96be5.jpg";
},{}],"BsiN":[function(require,module,exports) {
module.exports = "40.9f6d9012.jpg";
...
},{"./1.jpg":"NJSX","./10.jpg":"i4z2","./11.jpg":"PKe7","./12.jpg":"CS4A","./13.jpg":"uYgX","./14.jpg":"hIAS","./15.jpg":"TjQ6","./16.jpg":"AgKW","./17.jpg":"oxYq","./18.jpg":"f9Jt","./19.jpg":"BVGL","./2.jpg":"dFor","./20.jpg":"ctUQ","./21.jpg":"cwez","./22.jpg":"Kdac","./23.jpg":"enHr","./24.jpg":"X5n9","./25.jpg":"LXWM","./26.jpg":"Yk3M","./27.jpg":"XCdc","./28.jpg":"x75a","./29.jpg":"EOzq","./3.jpg":"P8tY","./30.jpg":"qjp4","./31.jpg":"c3lz","./32.jpg":"kgsa","./33.jpg":"CWo3","./34.jpg":"HaGS","./35.jpg":"ZCjW","./36.jpg":"Heda","./37.jpg":"jmQK","./38.jpg":"Oxcm","./39.jpg":"aZIu","./4.jpg":"kPmT","./40.jpg":"BsiN","./5.jpg":"VqBz","./6.jpg":"gtVS","./7.jpg":"HYBC","./8.jpg":"KW6U","./9.jpg":"xNmy"}],"Jy3L":[function(require,module,exports) {
"use strict";
...
var mousePosCache = mousepos; // mouse movement direction
...
var MenuItem = /*#__PURE__*/function () {
  function MenuItem(el, animatableProperties) {
    ...
    this.DOM.number = this.DOM.el.querySelector('.menu__item-number'); // menu item properties that will animate as we move the mouse around the menu

    this.animatableProperties = animatableProperties; // create the image structure
  ...
  _createClass(MenuItem, [{
    ...
    value: function layout() {
      ...
      var imgpos = this.DOM.el.dataset.img.match(/([\w\d_-]*)\.?[^\\\/]*$/i)[1] - 1;
      this.DOM.revealImage.style.backgroundImage = "url(".concat(images[imgpos][1], ")");
    ...
    value: function showImage() {
      ...
      }, 0) // scale animation for both inner & image
      .to(this.DOM.revealInner, {
        duration: 1,
        ease: 'expo',
        startAt: {
    ...
    value: function hideImage() {
      ...
      return new Promise(function (resolve) {
        // kill any current tweens
        _gsap.gsap.killTweensOf(_this3.DOM.revealInner);

        _gsap.gsap.killTweensOf(_this3.DOM.revealImage);
        ...
        }).to(_this3.DOM.revealInner, {
          scale: 0.8,
          x: '50%',
          y: '-150%',
          opacity: 0 //rotation: 0

        }).to(_this3.DOM.revealImage, {
          scale: 1.8
        }, 0);
      });
    ...
    value: function render() {
      ...
      this.animatableProperties.rotation.current = this.firstRAFCycle ? 0 : (0, _utils.map)(mouseDistanceX, 0, 200, 0, direction.x < 0 ? -100 : 100); // set up the interpolated values
      ...
      this.animatableProperties.rotation.previous = this.firstRAFCycle ? this.animatableProperties.rotation.current : (0, _utils.lerp)(this.animatableProperties.rotation.previous, this.animatableProperties.rotation.current, this.animatableProperties.rotation.amt); // set styles
...
},{"gsap":"TpQl","./utils":"MgTz","../img/*.jpg":"m7Bz"}],"oR66":[function(require,module,exports) {
...
},{}],"M3Rz":[function(require,module,exports) {
"use strict";
...
var ContentItem = /*#__PURE__*/function () {
  function ContentItem(el) {
    ...
    this.DOM.imgs = _toConsumableArray(this.DOM.el.querySelectorAll('.gallery__item-imginner'));
    this.DOM.caption = {
  ...
  _createClass(ContentItem, [{
    ...
    value: function initEvents() {
      ...
      this.DOM.caption.more.forEach(function (more, pos) {
        var img = _this.DOM.imgs[pos];

        var chars = _this.DOM.caption.title[pos].querySelectorAll('.char');

        more.addEventListener('mouseenter', function () {
          _gsap.gsap.killTweensOf([img, chars]);
...
},{"splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"oR66","splitting":"Qdhu","gsap":"TpQl"}],"tn5Z":[function(require,module,exports) {
"use strict";
...
var MenuController = /*#__PURE__*/function () {
  function MenuController(menuEl) {
    ...
    this.DOM.menuItems = _toConsumableArray(this.DOM.menu.querySelectorAll('.menu__item_hr')); // Menu item properties that will animate as we move the mouse around the menu
...
},{"gsap":"TpQl","./menuItem":"Jy3L","./contentItem":"M3Rz"}],"QvaY":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _preloader.preloader)('.menu__item_hr'), (0, _utils.preloadImages)('.gallery__item-imginner'), (0, _utils.preloadFonts)('zkq2mjw')]).then(function () {
  ...
  new _menuController.default(document.querySelector('.menu-hr')); // Mouse effects on all links and buttons

  _toConsumableArray(document.querySelectorAll('a, .gallery__item-more, .back')).forEach(function (link) {
...
},{"./utils":"MgTz","./preloader":"BeZ8","./cursor":"LMRJ","./menuController":"tn5Z"}]},{},["QvaY"], null)